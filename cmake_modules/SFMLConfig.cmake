...
set(FIND_SFML_PATHS
    ...
    /opt/csw
    /opt
    C:/Tools/SFML_my/lib/cmake/SFML
        C:/Tools/SFML_my/include
        C:/Tools/SFML_my/)
...
# W teście tworzymy 2 termPojnty, potem jeden modyfikujemy, adres IP, Fro, anything, żeby zobaczyć czy poprawnie się aktualizuje,
# a na końcu jest usuwanie tego pierwszego którego stworzyliśmy, czy ten drugi zostanie i będzie poprawnie działać, czyli czy zostanie
# tylko jeden i wszystko poprawnie się zaktualizuje, warto porozmawiać o tym z Sabiną, czy nie mają już takich testów przygotowanych or smth

# Dopytać się Bartka, czy on chce taki test żebyśmy napisali tylko dla siebie, czy dodać to do "nightly runy | CI loopy"?

# +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++

# Structure representing termPointToSgw with froRef and IPAddress members added to ShMLU.
# Mechanism for creating, deleting and modifying termPointToSgw structs in ShM added to RnhRadioConfConfigServerSwU.
# Map containing used termPointToSgw IP addresses added to RnhRadioConfConfigClientSwU.     

zamiast nrOfBearers()>0 => anyActive() -> jest gotowa funkcja, sprawdza każdy bearer, czy każdy NIE MA > SETUP_PHYSICAL_BEARER_INDEX_REJECT <
w G1 nie ma możliwości żeby wszystkie były inactive,
wstępnie zrobić to tylko w setupie
